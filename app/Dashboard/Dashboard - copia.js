let Html_Dashboard = `<section class="Dashboard">
    <section class="containner_Tarjetas_dashboard">
        ...
        <div class="Tarjeta_dashboard4 sub_card_Dashboard"> 
            ...
            <span class="info_sub_card" style="color:blue; font-weight:bold">0 entradas y 0 salidas</span>
...
function Dashboard(id) {
   ...
   document.getElementById(id).innerHTML = Html_Dashboard;
    ...
    api.send('get-informacion-producto-dasboard')
...
api.receive('productos-data-list-productos',(event,data_total_list)=>{
    ...
    console.log('productos-data-list-productos',)
